  ...
  describe('When I invoke "evaluate" function passing math equation as parameter', () => {
    describe('should returns proper result for:', () => {
      it('the equations of addition', () => {
        ...
        expect(mathUtils.evaluate('0.000000000001 + 0.000000000002')).toEqual(3e-12);
        expect(mathUtils.evaluate('1000000000000000000000000000000000000 + 2000000000000000000000000000000')).toEqual(1.000002e+36);
      });
      ...
      it('the equations of multiplications', () => {
        ...
        expect(mathUtils.evaluate('-0.234 * -0.5434 * -0.543535')).toEqual(-0.069113519046);
      });
      it('the equations of division', () => {
        ...
        expect(mathUtils.evaluate('-45 / 34 / 1.53453')).toEqual(-0.862498231879);
      });
